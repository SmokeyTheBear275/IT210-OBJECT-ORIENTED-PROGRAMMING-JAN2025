 ...
 * print out amount of times WHILE loop ran as years
 */
...
public class Population_while {
    public static void main(String[] args) {
        ...
        //Print initial population at 0 years
        System.out.printf("%8.0f%,22.0f%,22.0f%,22.0f\n",year,popUSA,popMexico,popJapan);

        //While loop for population change until USA pop is lowest of all
        while (popUSA > popMexico && popUSA > popJapan) {
